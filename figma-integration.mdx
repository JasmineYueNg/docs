...
<CardGroup cols={3}>
  <Card title="Design-First Approach" icon="palette">
    Use your Figma designs as the blueprint for AI code generation
  </Card>
  <Card title="Pixel-Perfect Output" icon="target">
    Generate HTML, CSS, and JavaScript that matches your designs exactly
  </Card>
  <Card title="Instant Conversion" icon="zap">
    Turn design mockups into functional web pages in minutes
  </Card>
</CardGroup>
...
<Card title="Perfect Accuracy" icon="check-circle">
  **Pixel-Perfect Code**
...
![Figma Personal Access Token Setup Interface showing security settings and token generation](/images/figma-token-setup-guide.png)
...
<CardGroup cols={2}>
  <Card title="Higher Accuracy" icon="crosshair">
    AI focuses on specific details of each section for precise code generation
  </Card>
  <Card title="Better Structure" icon="layout-grid">
  ...
  <Card title="Faster Iterations" icon="refresh-cw">
...
<AccordionGroup>
  <Accordion title="What is Figma integration and why do I need it?" icon="help-circle">
  ...
  <Accordion title="Do I need coding knowledge to use this?" icon="code">
  ...
  <Accordion title="How do I get a Figma Personal Access Token?" icon="key">
  ...
  <Accordion title="What Figma permissions do I need?" icon="shield-check">
  ...
  <Accordion title="Should I convert entire pages or sections?" icon="layout">
  ...
  <Accordion title="How do I copy a link to a specific section?" icon="link">
  ...
  <Accordion title="Will the generated code match my design exactly?" icon="target">
  ...
  <Accordion title="Does it work with responsive designs?" icon="smartphone">
  ...
  <Accordion title="What if I update my design later?" icon="refresh-cw">
  ...
  <Accordion title="Can I use Community templates?" icon="users">
