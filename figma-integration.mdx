...
<CardGroup cols={3}>
  ...
  <Card title="Pixel-Perfect Output" icon="check">
...
<CardGroup cols={2}>
  <Card title="Higher Accuracy" icon="circle">
    AI focuses on specific details of each section for precise code generation
  </Card>
  <Card title="Better Structure" icon="square">
  ...
  <Card title="Faster Iterations" icon="repeat">
...
<AccordionGroup>
  <Accordion title="What is Figma integration and why do I need it?" icon="info">
  ...
  <Accordion title="What Figma permissions do I need?" icon="shield">
  ...
  <Accordion title="Should I convert entire pages or sections?" icon="square">
  ...
  <Accordion title="Will the generated code match my design exactly?" icon="circle">
  ...
  <Accordion title="Does it work with responsive designs?" icon="phone">
  ...
  <Accordion title="What if I update my design later?" icon="repeat">
