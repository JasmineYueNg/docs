...
When no data exists yet, you will see a placeholder message:

<Note>
**No data yet.**

Tables will appear here once your project starts storing information.
</Note>
...
<Tabs>
  <Tab title="Free Users">
    <Card title="Export Restricted" icon="lock">
  ...
  <Tab title="Paid Users">
    <Card title="Full Export Access" icon="download">
...
<CardGroup cols={2}>
  <Card title="Row Operations" icon="circle-check">
    You **can** add, edit, and delete rows
  </Card>
...
<Warning>
Tables and columns are managed by the system. Users cannot add or remove tables or columns directly. This design keeps data structures stable and avoids accidental schema changes in production projects.
</Warning>
