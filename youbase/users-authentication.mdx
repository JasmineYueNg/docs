...
YouBase provides a default login interface styled for YouWare.

<Info>
**Customizing the Login UI**

You can customize the login interface to match your brand through iAgent.

If you've customized the UI and later modify your Auth settings, make sure to notify iAgent so the login page reflects the latest configuration.
</Info>
