...
You can customize the login interface to match your brand through Agent.

If you've customized the UI and later modify your Auth settings, make sure to notify Agent so the login page reflects the latest configuration.
</Info>
