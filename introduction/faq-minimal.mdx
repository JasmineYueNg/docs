---
title: "YouWare FAQ - Complete Guide to AI-Powered Web Development"
...
<AccordionGroup>
  ...
  <Accordion title="How do I debug or check what went wrong with my project?">
    ...
    <img 
      src="/images/browser-console-debug.png" 
      alt="Browser console showing debugging information for YouWare projects"
    />
  </Accordion>
  ...
  <Accordion title="What if I get a 500 error or a capacity limit message?">
    ...
    If the problem persists, please email us immediately at **support@youware.com** with:
    1. The project link
...
<AccordionGroup>
  ...
  <Accordion title="Where can I find help or interact with the YouWare community?">
    ...
    - **"Bounty Missions"**: Participate in reward-based tasks to solve specific problems or develop features, earning points and cash rewards
    - **Direct Support**: Contact our customer support team for technical issues

    <img 
      src="/images/youware-community-dashboard.png" 
      alt="YouWare community dashboard showing forums, bounty missions, and support options"
    />
  </Accordion>
</AccordionGroup>