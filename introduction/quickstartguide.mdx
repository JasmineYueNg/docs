...
<Steps>
  <Step title="Create Your First Project" href="#step-1-create-your-first-project">
    Describe your idea and let AI build it.
  </Step>
  
  <Step title="Edit & Refine" href="#step-2-edit--refine-your-project">
    Use visual editing, chat with AI, or edit code directly.
  </Step>
  
  <Step title="Publish" href="#step-3-publish-and-share">
