...
<AccordionGroup>
  ...
  <Accordion title="Access Top AI Models" icon="bot">
...
<AccordionGroup>
  <Accordion title="Does the AI App tool help me generate my website design?" icon="bot">
  ...
  <Accordion title="Can I build a chatbot website using the AI App tool?" icon="message-square">
  ...
  <Accordion title="What's the difference between YouWare's core AI and the AI App tool?" icon="bot">
