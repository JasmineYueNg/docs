...
<CardGroup cols={2}>
  ...
  <Card title="Faster Iterations" icon="fast-forward">
...
<AccordionGroup>
  <Accordion title="What is Figma integration and why do I need it?" icon="help">
  ...
  <Accordion title="What Figma permissions do I need?" icon="lock">
  ...
  <Accordion title="Will the generated code match my design exactly?" icon="check">
  ...
  <Accordion title="What if I update my design later?" icon="refresh">
